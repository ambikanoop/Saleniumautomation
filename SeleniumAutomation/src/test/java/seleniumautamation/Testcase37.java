...
public class Testcase37 {
	...
	endtime.sendKeys("7:00 PM");
       WebElement recurring=driver.findElement(By.xpath("//*[@id=\"IsRecurrence\"]"));
       recurring.click();
       ...
       enddate.click();
       WebElement month=driver.findElement(By.xpath("//*[@id=\"calMonthPicker\"]"));
       Select s=new Select(month);
       s.selectByVisibleText("April");
       WebElement year=driver.findElement(By.xpath("//*[@id=\"calYearPicker\"]"));
       Select s1=new Select(year);
       s1.selectByVisibleText("2024");
       driver.findElement(By.xpath("//*[@id=\"calRow2\"]/td[5]")).click();
	...
	wait1.until(ExpectedConditions.visibilityOf(monthview));
       monthview.click();
      //
